cvpso_obj_func <- function(wgts, v, date_interval, cov, mean_returns, prices, env, save_stats = FALSE){
...
cvpso_wrapper <- function(v, save_stats = FALSE){
  env <- new.env()
